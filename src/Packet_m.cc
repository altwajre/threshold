...
Packet::Packet(const Packet &other) : ::omnetpp::cPacket(other) { copy(other); }
...
int Packet::getSrcAddr() const { return this->srcAddr; }

void Packet::setSrcAddr(int srcAddr) { this->srcAddr = srcAddr; }

int Packet::getPacketType() const { return this->packetType; }

void Packet::setPacketType(int packetType) { this->packetType = packetType; }
...
Register_ClassDescriptor(PacketDescriptor)
    ...
    : omnetpp::cClassDescriptor("Packet", "omnetpp::cPacket") {
  propertynames = nullptr;
}

PacketDescriptor::~PacketDescriptor() { delete[] propertynames; }
...
int PacketDescriptor::findField(const char *fieldName) const {
  ...
  if (fieldName[0] == 'p' && strcmp(fieldName, "packetType") == 0)
    return base + 1;
...
const char *PacketDescriptor::getFieldProperty(int field,
...
const char *PacketDescriptor::getFieldDynamicTypeString(void *object, int field,
                                                        int i) const {
  omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
  if (basedesc) {
    if (field < basedesc->getFieldCount())
...
std::string PacketDescriptor::getFieldValueAsString(void *object, int field,
                                                    int i) const {
  omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
  if (basedesc) {
    if (field < basedesc->getFieldCount())
  ...
  switch (field) {
    case 0:
      return long2string(pp->getSrcAddr());
    case 1:
      return long2string(pp->getPacketType());
    default:
      return "";
  }
}

bool PacketDescriptor::setFieldValueAsString(void *object, int field, int i,
  ...
  switch (field) {
    case 0:
      pp->setSrcAddr(string2long(value));
      return true;
    case 1:
      pp->setPacketType(string2long(value));
      return true;
    default:
      return false;
  }
...
void *PacketDescriptor::getFieldStructValuePointer(void *object, int field,
                                                   int i) const {
  omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
  if (basedesc) {
    if (field < basedesc->getFieldCount())
